...
import ControlledCarousel from '../common/ControlledCarousel.js'
        ...
        <div className="app-body">
          <Switch>
            ...
            <PrivateRoute path="/profile" authenticated={this.state.authenticated} currentUser={this.state.currentUser}
              ...
              <PrivateRoute path="/ControlledCarousel" authenticated={this.state.authenticated} currentUser={this.state.currentUser}
              component={<ControlledCarousel />}></PrivateRoute>
            <Route path="/login"
